...
ApplicationWindow {
    ...
    menuBar: ThemedMenuBar {
        ...
        ThemedMenu {
            ...
            Action {
                text: qsTr("Home")
                onTriggered: webIntegration.gotoPage("home")
            }
    ...
    MprisPlayer {
        ...
        onShuffleRequested: webIntegration.shuffle(shuffle)
        onSongInfoChanged: {
    ...
    QtObject {
        ...
        signal shuffle(var shuffle)
        signal setTheaterMode(var mode)
    ...
    Settings {
        ...
        property alias theaterMode: webIntegration.theaterMode
    }
}
